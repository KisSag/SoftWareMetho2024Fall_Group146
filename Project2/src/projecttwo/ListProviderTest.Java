...
public class ListProviderTest {
    ...
    public void testAdd() {
        ...
        Doctor doctor = new Doctor(new Profile("Huang", "Tianxiang", new Date(5, 15, 1990)), Location.HOSPITAL, Specialty.CARDIOLOGY, "12345");
        Technician technician = new Technician(new Profile("Eric", "Wang", new Date(6, 10, 1985)), Location.CLINIC, "50");
